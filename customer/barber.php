...
<body>
    ...
    $userrow = $database->query("select * from customer where cemail='$useremail'");
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor menu-active menu-icon-doctor-active">
                        <a href="barber.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">All Barbers</p></a></div>
                    </td>
                </tr>
...
?>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="barber.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Show all Doctors &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            $sqlmain = "SELECT * FROM barber WHERE barid=?";
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>Redirect to Barbers sessions?</h2>
                        <a class="close" href="barber.php">&times;</a>
                        <div class="content">
