                    ...
                    if($_POST){
                        ...
                        if(isset($_POST["filter"])){
                            if($_POST["showonly"]=='all'){
                                ...
                                $sqlmain= "select * from appointment inner join customer on customer.cid=appointment.pid inner join schedule on schedule.scheduleid=appointment.scheduleid where schedule.barid=$userid;";
                                $selecttype="My";
                                $current="My Customers Only";
                            }
                        }
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <?php
                               ...
                               //$list12= $database->query("select * from appointment inner join patient on customer.cid=appointment.pid inner join schedule on schedule.scheduleid=appointment.scheduleid where schedule.barid=1;");
