                                ...
                                <td width="50%">
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain= "select appointment.appoid,schedule.scheduleid,schedule.title,barber.barname,customer.cname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join customer on customer.cid=appointment.pid inner join barber on schedule.barid=barber.barid  where schedule.scheduledate>='$today'  and schedule.scheduledate<='$nextweek' order by schedule.scheduledate desc";
                                ...
                                <td width="50%" style="padding: 0;">
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                            $sqlmain= "select schedule.scheduleid,schedule.title,barber.barname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join barber on schedule.barid=barber.barid  where schedule.scheduledate>='$today' and schedule.scheduledate<='$nextweek' order by schedule.scheduledate desc"; 
                                                $result= $database->query($sqlmain);
